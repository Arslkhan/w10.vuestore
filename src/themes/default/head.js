export default {
  title: '',
  titleTemplate: '%s W10 Collapsible Cup and Eco-Friendly Drinkware',
  htmlAttrs: {
    lang: 'en'
  },
  meta: [
    { charset: 'utf-8' },
    { vmid: 'description', name: 'description', content: 'W10 - Introducing the worlds 1st double walled Collapsible Cup and a new range of stylish, competitively priced, environmentally friendly drinkware. The range includes both desk cups and travel cups, and some that are suitable for both.' },
    { name: 'viewport', content: 'width=device-width, initial-scale=1, minimal-ui' },
    { name: 'robots', content: 'index, follow' },
    { name: 'mobile-web-app-capable', content: 'yes' },
    { name: 'theme-color', content: '#ffffff' },
    { name: 'apple-mobile-web-app-status-bar-style', content: '#ffffff' },
    { name: 'google-site-verification', content: 'HIKiTAHvVVJUue2zI660vu9G4j2tMIpY6tl3KemnRbo' }
  ],
  link: [
    ...
    { rel: 'stylesheet', as: 'style', href: 'https://fonts.googleapis.com/css2?family=Raleway:wght@100;200;300;400;500;600&display=swap' },
    { rel: 'stylesheet', as: 'style', href: 'https://fonts.googleapis.com/css2?family=Material+Icons&display=swap' },
    { rel: 'stylesheet', as: 'style', href: 'https://fonts.googleapis.com/css2?family=Montserrat:wght@500&display=swap' },

        ...
        <div class="flex w-100 flex-wrap between-xs">
          <div>
            ...
            <div class="h6 cl-bg-tertiary pt5 sku" data-testid="productSku">
               <span v-if="product.short_description">{{ product.short_description | strippedContent }}</span>
            </div>
            ...
            <div class="h6 pt5 cl-success hidden" v-if="hasProductInfo && !hasProductErrors">
